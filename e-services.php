                    ...
                    <section class="snapshots" id="snapshot">
                        <div class="wrapper">
                            ...
                            <div class="snapshots-left">
                                ...
                                padding: 10px;color: #fff;"> eCitizen payment</h4>
                                <div class="highlights">
                                    <div class="highlights-inner">
                                        <div class="flex">
                                            ...
                                            <div class="snap-info">
                                                <p class="text-black">Integrated Financial Management System (IFMS) is an IT-based
                                                    budgeting and accounting system that manages spending, payment
                                                    processing, budgeting, and reporting for governments and other
                                                    entities. An IFMS bundles many essential financial management
                                                    functions into one software suite.<br> An integrated financial
                                                    management system is also known as an integrated financial
                                                    management information system (IFMIS).
                                                </p>
                                                <p class="text-black"><span>Key Features:-</span> <br>
                                                    • Enhanced management of cash, debt and liabilities <br>
                                                    • Ability to use historical information to provide better budget
                                                    modelling proces <br>
                                                    • Reduced cost for financial transactions <br>
                                                    • Increased decision-making efficiency</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
