...
include_once 'core/noticeList.core.php';
...
<body>
    ...
    <div class="animsition">
        ...
        <div class="section over-hide padding-top-120 padding-top-mob-nav">
            <div class="top-header-parallax-section corporate-hero-back-img-1 section-background-notice parallax-hero-1200">
            </div>
        ...
        <div class="tender-container">
            <div class="tenders">
                <div class="tender1 active-tender"><a href="notice.php" class="bold">Latest Notice</a></div>
                <div class="tender2"><a href="notice-archives.php">Archives</a></div>
            </div>
            <hr>
