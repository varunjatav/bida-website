...
include_once 'core/archivesList.core.php';
...
<body>
    ...
    <div class="animsition">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            ...
                            <p class="lead mb-0 color-white title-text-left-line-small">
                                Everything you need to know about Tenders
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="tender-container">
            <div class="tenders">
                <div class="tender1"><a href="tender.php" class="bold">Latest Tenders</a></div>
                <div class="tender2 active-tender"><a href="archives.php">Archives</a></div>
            </div>
            <hr>
            <div class="tender-card" style="display:none;">
...
Industrial Development Authority BIDA</div>
                ...
                <div class="tender-time">
                    <div class="tt1">Release Date : 5 Jan 2021</div>
                    <div class="tt3">Bid Submission : 6 May 2021</div>
                    <div class="tt2" style="text-align:center;">Bid Opening & Pre Qualification Check :7 May 2021</div>

                    <div class="tt4">Financial Bid opening : 7 May 2021</div>
                </div>

                <div class="tender-details">This RFQ has been canceled. Please refer the new tender (Reference number 2024_BUIDA_890788_1)</div>
                <hr>
                ...
                <div class="tender-links-div">
                    ...
                    <div class="link1">
                        <ul>
                            <li><span><a href="img/tenderpdf.pdf" style="color:#FF0000">RFQ Document </a>&nbsp;</span></li>
                            <li><span><a href="img/tenderpdf.pdf" style="color:#FF0000">Corrigendum</a>&nbsp;</span></li>
                            <li><span><a href="img/tenderpdf.pdf" style="color:#FF0000">Corrigendum 2</a>&nbsp;</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            ?>
                <div class="tender-card">
                    ...
                    <div class="tender-time">
                        ...
                        <div class="tt3">Bid Submission : <?php echo $row['BidSubmission'] == 0 ? '--' : date('d/m/Y', $row['BidSubmission']); ?></div>
