                ...
                <div class="container-fluid mt-2">
                    <div class="row">
                        <div class="col-md-3 col-12 mb-3">
                            <img src="img/sidebanner.png" alt="image" class="img-fluid">
                        </div>
                                ...
                                <table class="table table-striped table-bordered border-primary">
                                    <thead style="background-color: #99cc33;">
                                        <tr>
                                            ...
                                            <th scope="col">Rules and Guidelines</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>Manual for planning and development of urban roads and streets</td>
                                            <td><a href="img/mpd.pdf" target="_blank">Download</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            <td>A guide for inclusive, Accessible Safe and Resilient Urban Development</td>
                                            <td><a href="img/aguideforinclusiveaccessiblesafeandrefilienturbandevelopment.pdf" target="_blank">Download</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">3</th>
                                            <td>Guidebook for Adoption of Form Based Codes</td>
                                            <td><a href="img/gabc.pdf" target="_blank">Download</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">4</th>
                                            <td>URDPFI Guidelines</td>
                                            <td><a href="img/urdpfiguidelinescompiled.pdf" target="_blank">Download</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">5</th>
                                            <td>Formulation of GIS based master plans For AMRUT cities</td>
                                            <td><a href="img/gis.pdf" target="_blank">Download</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row" rowspan="7">6</th>
                                            <td colspan="2">CPHEOO Manual</td>
                                        </tr>
                                        <tr><td>1. Manual on Storm Water Drainage Systems</td><td><a href="img/manualonstormwaterdrainagesystems.pdf" target="_blank">Download</a></td></tr>
                                        <tr><td>2. Manual on Municipal Solid Waste Management - 2016</td><td><a href="img/solidwastemanagement.pdf" target="_blank">Download</a></td></tr>
                                        <tr><td>3. Manual on Sewerage and Sewage treatment system</td><td><a href="img/sewagetreatment.pdf" target="_blank">Download</a></td></tr>
                                        <tr><td>4. Manual on Operation and Maintenance of Water Supply System</td><td><a href="img/watersupply.pdf" target="_blank">Download</a></td></tr>
                                        <tr><td>5. Manual on Municipal Solid Waste Management </td><td><a href="img/solidwaste.pdf" target="_blank">Download</a></td></tr>
                                        <tr><td>6. Manual on Water Supply and Treatment - 1999</td><td><a href="img/water.pdf" target="_blank">Download</a></td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
